...
public class Prim implements AlgoritmoGeneracion {
    ...
    public List<List<Celda>> generarLaberinto(int ancho, int alto, String laberintoId) {
        ...
        // Empezar desde una celda aleatoria (asegurando que sea impar para mantener conectividad)
    ...
    private void agregarVecinosAFrontera(List<List<Celda>> grid, Celda celda, 
                                       List<Celda> frontera, Set<String> visitados, 
                                       int ancho, int alto) {
    ...
    private void conectarConVecinoVisitado(List<List<Celda>> grid, Celda celda, 
